...
final class CGImageTests: XCTestCase {
  ...
  func testiOSJpgIsNearlyIdenticalTo() {
    XCTAssertTrue(
      self.jpegFixture("gerA.JPG")
        .isNearlyIdenticalTo(self.jpegFixture("gerB.JPG"))
    )
  }

  func testiOSPngIsNearlyIdenticalTo() {
    XCTAssertTrue(
      self.pngFixture("ger1.PNG")
        .isNearlyIdenticalTo(self.pngFixture("ger2.PNG"))
    )
    XCTAssertTrue(
      self.pngFixture("ger2.PNG")
        .isNearlyIdenticalTo(self.pngFixture("ger3.PNG"))
    )

    XCTAssertTrue(
      self.pngFixture("home1.PNG")
        .isNearlyIdenticalTo(self.pngFixture("home2.PNG"))
    )
    XCTAssertTrue(
      self.pngFixture("home2.PNG")
        .isNearlyIdenticalTo(self.pngFixture("home3.PNG"))
    )

    XCTAssertTrue(
      self.pngFixture("apps1.PNG")
        .isNearlyIdenticalTo(self.pngFixture("apps2.PNG"))
    )
    XCTAssertTrue(
      self.pngFixture("apps2.PNG")
        .isNearlyIdenticalTo(self.pngFixture("apps3.PNG"))
    )
  }

  func testiOSisDifferent() {
    XCTAssertFalse(self.jpegFixture("iPadA.JPG").isNearlyIdenticalTo(self.jpegFixture("iPadB.JPG")))
    XCTAssertFalse(
      self.pngFixture("apps1.PNG")
        .isNearlyIdenticalTo(self.pngFixture("ger1.PNG"))
    )
    XCTAssertFalse(
      self.pngFixture("home1.PNG")
        .isNearlyIdenticalTo(self.pngFixture("ger1.PNG"))
